...
import "../css/CompanyDetail.css"; // Importing CSS for styling
            ...
            >
                <Group align="center" mb="sm">
                    ...
                    <div>
                        ...
                        <Text color="dimmed" className="company-detail-website">
                            {company.website || "No website available"}
                        </Text>
                        <Text
                            color="dimmed"
                            size="sm"
                            className="company-detail-email"
                        >
                ...
                <Text>
                    Total Billing Value:{" "}
                    {company.analytics?.totalBillingValue || 0}
                </Text>
                ...
                <Text>
                    Company Size Code:{" "}
                    {company.companySizeCode || "Not provided"}
                </Text>
